  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_sharedTrackingLibrary_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==2) {
    c2_sharedTrackingLibrary_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
      ...
      if (!strcmp(machineName,"sharedTrackingLibrary")) {
        if (nrhs==3) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void sf_c1_sharedTrackingLibrary_get_check_sum(mxArray
                *plhs[]);
              sf_c1_sharedTrackingLibrary_get_check_sum(plhs);
              break;
            }

           case 2:
            {
              extern void sf_c2_sharedTrackingLibrary_get_check_sum(mxArray
                *plhs[]);
              sf_c2_sharedTrackingLibrary_get_check_sum(plhs);
              break;
            }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "sudQgAExnrh5eBQi3jiTjMC") == 0) {
     ...
     case 2:
      {
        if (strcmp(instanceChksum, "s6gCNEkaxRWvcDgWPtYMRiF") == 0) {
          extern const mxArray
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "sudQgAExnrh5eBQi3jiTjMC") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "s6gCNEkaxRWvcDgWPtYMRiF") == 0) {
  ...
  boolean_T isModelRef, boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "sharedTrackingLibrary", "Furuta_Control");
