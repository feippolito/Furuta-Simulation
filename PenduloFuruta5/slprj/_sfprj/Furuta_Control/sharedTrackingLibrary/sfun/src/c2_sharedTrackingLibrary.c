...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2758966482U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1341239048U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2751822825U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(488562271U);
}
...
{
  return "s6gCNEkaxRWvcDgWPtYMRiF";
}
...
static void mdlSetWorkWidths_c2_sharedTrackingLibrary(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3656794701U));
  ssSetChecksum1(S,(4244271719U));
  ssSetChecksum2(S,(4076532663U));
  ssSetChecksum3(S,(1062754373U));
