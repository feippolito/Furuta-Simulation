...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2076757596U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1457886127U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2198296348U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3052901522U);
}
...
{
  return "sudQgAExnrh5eBQi3jiTjMC";
}
...
static void mdlSetWorkWidths_c1_sharedTrackingLibrary(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3501890084U));
  ssSetChecksum1(S,(3161326590U));
  ssSetChecksum2(S,(421854201U));
  ssSetChecksum3(S,(2707890197U));
