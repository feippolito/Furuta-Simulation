...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Furuta_Control_all_states_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_sharedTrackingLibrary_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Furuta_Control_all_states_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_Furuta_Control_all_states_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Furuta_Control_all_states") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Furuta_Control_all_states_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_Furuta_Control_all_states_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Furuta_Control_all_states") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Furuta_Control_all_states_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_Furuta_Control_all_states_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Furuta_Control_all_states") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Furuta_Control_all_states_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Furuta_Control_all_states_updateBuildInfo_args_info
  ...
  if (strcmp(machineName, "Furuta_Control_all_states") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Furuta_Control_all_states_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_Furuta_Control_all_states_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "Furuta_Control_all_states") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Furuta_Control_all_states_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_Furuta_Control_all_states_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Furuta_Control_all_states")) {
    return(sf_Furuta_Control_all_states_method_dispatcher(simstructPtr,
...
extern void Furuta_Control_all_states_terminator(void);
...
void sf_machine_global_terminator(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    Furuta_Control_all_states_terminator();
...
extern void Furuta_Control_all_states_initializer(void);
extern void sharedTrackingLibrary_initializer(void);
extern void Furuta_Control_all_states_register_exported_symbols(SimStruct* S);
extern void sharedTrackingLibrary_register_exported_symbols(SimStruct* S);
extern void Furuta_Control_all_states_debug_initialize(struct
...
{
  Furuta_Control_all_states_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Furuta_Control_all_states_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    Furuta_Control_all_states_initializer();
    if (!simModeIsRTWGen) {
